...
class Modal { 
  ...
  open() {
    ...
    normalP.append('In Normal Mode, you write out a sentence about anything you want. That sentence then gets fed into DeepAI\'s API, which then generates what it thinks is a relevant block of text.');
    const normalP2 = document.createElement('p');
    normalP2.append('Thanks to the AI, your typing test can be about anything you want! If you put in some lines of code, you\'ll get back many other lines of code.')
