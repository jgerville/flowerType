...
class TextStats {
  ...
  addSubmitButtonListener() {
    ...
    submitScoreContainer.addEventListener(
      "click",
      this.boundSubmitButtonListener
    );
  }
    ...
    if (e.target.classList.contains("submit-score-button")) {
      ...
      if (submitScoreInput.value) {
        ...
        try {
          ...
          const submitScoreContainer = Util.q(".submit-score-container");
          submitScoreContainer.removeEventListener(
            "click",
            this.boundSubmitButtonListener
          );
        } catch (error) {
          this._addErrorToSubmitScore(
        ...
        this._addErrorToSubmitScore(
          "Make sure to enter a name before submitting!"
        );
      }
    }
  }
